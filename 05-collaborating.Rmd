...
Compared to LaTeX, overleaf is relatively new. The British company responsible (Write Latex Limited) was founded in 2013 by [John Lees-Miller](https://www.linkedin.com/in/jdleesmiller/) and [John Hammersley](https://www.linkedin.com/in/john-hammersley-6419a266/) to allow easier collaboration between authors. Overleaf has several features which you might find useful:
