...
```{r overleaf-fig, echo = FALSE, fig.align = "center", out.width = "100%", fig.cap='A screenshot of overleaf showing the source TeX on the left hand side and the corresponding pdf on the right hand side. Screenshot by Dan Cherniy via Wikimedia Commons, see appendix for full image credit'}
