...
Unlike most word processors, LaTex is **not** a WYSIWYG system (what you see is what you get). The raw document you edit (a `*.tex` file) is not your final output (its usually a `*.pdf` file).
