...
(This chapter uses mathematics, if you can't see the equations and matrix below in your web browser, you'll need to use the pdf version of this document at [latex4year1.pdf](https://latex4year1.netlify.app/latex4year1.pdf). Otherwise, read on below.)
