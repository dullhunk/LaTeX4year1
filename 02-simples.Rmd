...
The text here is excerpted from *The New Turing Omnibus: 66 excursions in Computer Science* [@turingomnibus]. The Omnibus is a lovely introduction to the fundamentals of Computer Science that you might enjoy. In his book review, the software engineer [Jeff Atwood](https://en.wikipedia.org/wiki/Jeff_Atwood) calls it an “incredibly fun little book”. [@codinghorror]
