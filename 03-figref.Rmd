...
```{r wikipedian-fig, echo = FALSE, fig.align = "center", out.width = "70%", fig.cap='It has always been important to cite your sources and LaTeX gives you the tools to cite properly. Wikipedian protester by Randall Munro at XKCD, see appendix for full image credits'}
...
```{r turing-fig, echo = FALSE, fig.align = "center", out.width = "40%", fig.cap='Alan Turing at the age of sixteen, public domain, via Wikimedia Commons, see appendix for full image credit'}
