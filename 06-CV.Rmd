...
(ref:captioncv) A fictitious example CV using an overleaf template. Would you invite Neil to interview based on his CV? This is what your CV needs to do, convince a decision maker they really need to contact you to find out more. This is just a screenshot, the pdf can be found at [cdyf.me/Neil_Pointer.pdf](https://www.cdyf.me/Neil_Pointer.pdf). There are [over 600 CV templates available on overleaf](https://www.overleaf.com/gallery/tagged/cv) for you to choose from.
