...
* Spring insights during easter next year
    ...
    * see insight events at [gradcracker.com/search/computing-technology/work-placements-internships?duration=Insight_Events](https://www.gradcracker.com/search/computing-technology/work-placements-internships?duration=Insight%20Events)
* Summer internships suitable for first years:
    + see summer internships (open to first years) at [gradcracker.com/search/computing-technology/work-placements-internships?duration=Summer-open_to_1st_years](https://www.gradcracker.com/search/computing-technology/work-placements-internships?duration=Summer%20-%20open%20to%201st%20years)
