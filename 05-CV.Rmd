...
You'll write many documents at University, but there is one document that is **really** seriously important in a potentially life-changing way. Your curriculum vitae^[actually it's vitæ (not vitae) if you're being pedantic] or resume. An example CV is shown in Figure \@ref(fig:cv-fig).
