...
\hypersetup{
  ...
  pdfauthor={A laboratory manual written by Duncan Hull},
  hidelinks,
...
\date{Last updated on 04 December, 2020}
...
\caption{The LaTeX project logo, for image credits see appendix}\label{fig:latexproject-fig}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.47\linewidth]{images/Leslie_Lamport} \includegraphics[width=0.47\linewidth]{images/KnuthAtOpenContentAlliance} \caption{Turing award winners Leslie Lamport and Donald Knuth created TeX and LaTeX during the 1980's. See Appendix for image credits}\label{fig:knuthport-fig}
\end{figure}
...
In your \texttt{*.tex} file it looks like this:

\texttt{Turing\ addressed\ the\ question\ \textasciigrave{}\textasciigrave{}Can\ machines\ think?\textquotesingle{}\textquotesingle{}}
...
\caption{It has always been important to cite your sources and LaTeX gives you the tools to cite properly. Wikipedian protester by Randall Munro at XKCD, see appendix for full image credits}\label{fig:wikipedian-fig}
\end{figure}
...
\caption{Alan Turing at the age of sixteen, public domain, via Wikimedia Commons, see appendix for full image credit}\label{fig:turing-fig}
\end{figure}
...
\caption{A screenshot of overleaf showing the source TeX on the left hand side and the corresponding pdf on the right hand side. Screenshot by Dan Cherniy via Wikimedia Commons, see appendix for full image credit}\label{fig:overleaf-fig}
\end{figure}

Compared to LaTeX, overleaf is relatively new. The British company responsible (Write Latex Limited) was founded in 2013 by \href{https://www.linkedin.com/in/jdleesmiller/}{John Lees-Miller} and \href{https://www.linkedin.com/in/john-hammersley-6419a266/}{John Hammersley} to allow easier collaboration between authors. Overleaf has several features which you might find useful:
...
\caption{An example CV using an overleaf template. Would you invite Jake to interview based on his CV? This is what your CV needs to do, convince a decision maker they really need to contact you to find out more. There are over 600 CV templates available on overleaf. See Appendix for full image credit. }\label{fig:cv-fig}
\end{figure}
...
\chapter{Image credits}\label{pictures}}

Figure \ref{fig:latexproject-fig}: LaTeX project logo by \href{https://www.jonas.me/}{Jonas Jacek} CC BY 4.0 via Wikimedia Commons \href{https://w.wiki/oZs}{w.wiki/oZs}

Figure \ref{fig:knuthport-fig}: Leslie Lamport portrait by Leslie Lamport, GFDL via Wikimedia Commons \href{https://w.wiki/oyM}{w.wiki/oyM}, Knuth portrait by Jacob Appelbaum CC BY-SA via Wikimedia Commons \href{https://w.wiki/oyL}{w.wiki/oyL}

Figure \ref{fig:wikipedian-fig}: \emph{Wikipedian Protester} cartoon by \href{https://en.wikipedia.org/wiki/Randall_Munroe}{Randall Munroe} at \href{https://xkcd.com/285/}{xkcd.com/285} published under a \href{https://creativecommons.org/licenses/by-nc/2.5/}{Creative Commons Attribution-NonCommercial 2.5 License}

Figure \ref{fig:turing-fig}: Alan Turing at the age of sixteen, portrait by unknown author, public domain, via Wikimedia Commons \href{https://w.wiki/oZx}{w.wiki/oZx}

Figure \ref{fig:overleaf-fig}: Overleaf screenshot by Dan Cherniy via Wikimedia Commons at \href{https://w.wiki/omo}{w.wiki/omo}

Figure \ref{fig:cv-fig}: CV by Jake Gutierrez and published under an MIT license at \href{https://www.overleaf.com/latex/templates/jakes-resume/syzfjbzwjncs}{overleaf.com/latex/templates/jakes-resume/syzfjbzwjncs}
