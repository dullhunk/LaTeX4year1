...
He wrote thinking machines in 1950. \citep{turing50}''
...
\NormalTok{He wrote thinking machines in 1950. }\KeywordTok{\textbackslash{}cite}\NormalTok{\{}\ExtensionTok{turing50}\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\tightlist
\item
  Spring insights during easter next year\footnote{see the essential guide to student insights at \url{https://www.ratemyplacement.co.uk/insights}} some of which have application deaddlines before Christmas
\item
...
\item
  Is your CV robot proof? Many large employers use applicant tracking systems where your CV is screened by software long before a human ever sees it. Feed it through software like \href{http://careerset.io/manchester}{careerset.io/manchester} and \href{https://resume.io/}{resume.io}, what feedback do the robots give you? How can you make it more robot proof?
\item
