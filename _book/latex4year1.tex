...
Unlike most word processors, LaTex is \textbf{not} a WYSIWYG system (what you see is what you get). The raw document you edit (a \texttt{*.tex} file) is not your final output (its usually a \texttt{*.pdf} file).
