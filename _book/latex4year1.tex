...
The text here is excerpted from \emph{The New Turing Ominbus: 66 excursions in Computer Science} \citep{turingomnibus}. The Omnibus is a lovely introduction to the fundamentals of Computer Science that you might enjoy. The software engineer \href{https://en.wikipedia.org/wiki/Jeff_Atwood}{Jeff Atwood} in his book review called it an ``incredibly fun little book''. \citep{codinghorror}
...
(This chapters uses mathematics, if you can't see the equations below in your web browser, you'll need to use the pdf version of this document at \href{https://latex4year1.netlify.app/latex4year1.pdf}{latex4year1.netlify.app/latex4year1.pdf}. Otherwise, read on below.)
...
\item
  Create and save a simple document using the tutorial at \href{https://www.overleaf.com/learn/how-to/Creating_a_document_in_Overleaf}{overleaf.com/learn/how-to/Creating\_a\_document\_in\_Overleaf}\\
\item
...
You'll write many documents at University, but there is one document that is \textbf{really} seriously important in a potentially life-changing way. Your curriculum vitae\footnote{actually it's vitæ (not vitae) if you're being pedantic} or resume. An example CV is shown in Figure \ref{fig:cv-fig}.
...
\tightlist
\item
  Spring insights during easter next year\footnote{see the essential guide to student insights at \url{https://www.ratemyplacement.co.uk/insights}}
\item
...
\item
  your experience, voluntary, paid, casual, technical and non-technical
\item
  your projects: personal or at University and beyond
\end{itemize}
...
\item
  Does it fit comfortably on preferably one page (Résumé) or two pages (CV) only?
\item
  Is it in reverse chronological order? The most important (usually recent) things should be first?
\item
...
\item
  Is your CV robot proof? Many large employers use applicant tracking systems where your CV is screened by software long before a human ever sees it. Feed it through software like \href{http://careerset.io/manchester}{careerset.io/manchester} and \href{https://resume.io/}{resume.io}. What feedback do the robots give you?
\item
...
Your CV is a \emph{really} important document. We recommend you start working on it sooner rather than later and get feedback from as many different people (and bots) as you reasonably can.
