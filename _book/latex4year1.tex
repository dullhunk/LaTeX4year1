...
\date{Last updated on 15 November, 2023}
...
\hypertarget{latex-is-not-a-word-processor}{%
\section{LaTeX is NOT a word processor}\label{latex-is-not-a-word-processor}}
...
\item
  ...
  \item
    see insight events at \href{https://www.gradcracker.com/search/computing-technology/work-placements-internships?duration=Insight\%20Events}{gradcracker.com/search/computing-technology/work-placements-internships?duration=Insight\_Events}
  \end{itemize}
\item
  ...
  \tightlist
  \item
    see summer internships (open to first years) at \href{https://www.gradcracker.com/search/computing-technology/work-placements-internships?duration=Summer\%20-\%20open\%20to\%201st\%20years}{gradcracker.com/search/computing-technology/work-placements-internships?duration=Summer-open\_to\_1st\_years}
  \item
