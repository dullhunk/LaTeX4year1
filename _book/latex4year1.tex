...
To generate the bibliography you'll need to add these two lines. If your bib file is called \texttt{turing.bib} then you'll need to say \texttt{\textbackslash{}bibliography\{turing\}}
