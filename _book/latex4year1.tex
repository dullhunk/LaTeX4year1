...
Unlike most word processors, LaTex is \textbf{not} a WYSIWYG system (what you see is what you get). The raw document you edit (a \texttt{*.tex} file) is not your final output (usually a \texttt{*.pdf} file).
...
To generate the bibliography you'll need to add these two lines. If your bib file is calle \texttt{turing.bib} then you'll need to say \texttt{\textbackslash{}bibliography\{turing\}}
