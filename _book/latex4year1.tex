...
\date{Last updated on 25 November, 2024}
...
You've probably never noticed these details because most word processing software\footnote{Microsoft Word, Google Docs etc}, automatically corrects quotations marks for you. Since LaTeX isn't a word processor (see section \ref{notword}) it leaves your mistakes on the page for all to see. While the difference is subtle in most web browsers, it's really noticeable in print and pdf so worth paying attention to.
