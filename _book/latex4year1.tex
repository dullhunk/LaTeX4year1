...
\hypersetup{
  ...
  pdfauthor={A laboratory manual written by Duncan Hull at the University of Manchester},
  hidelinks,
...
\hypertarget{improve-this-guide}{%
\section*{Improve this guide}\label{improve-this-guide}}
\addcontentsline{toc}{section}{Improve this guide}

The source of this document is on github so if you have any comments or suggestions on how to improve it, you can \href{https://github.com/dullhunk/lateX4year1/issues}{raise an issue} or \href{https://github.com/dullhunk/LaTeX4year1/pulls}{submit a pull request}.

\hypertarget{latex}{%
\chapter{What is LaTeX?}\label{latex}}

LaTeX is a document preparation system for high-quality typesetting. \citep{latexproject} LaTeX is a mature and established typesetting system that has been around since 1980's. \citep{knuth} It is most often used for technical or scientific documents but it can be used for almost any form of publishing, including writing CVs and formal letters. Whatever documents you create with LaTeX, one of its key strengths is making them look professional in portable document format (pdf) using industrial strength typesetting.
...
LaTeX is not a word processor! Instead, LaTeX encourages you to concentrate on getting on the content and will take care of many of the details of its presentation. This is similar to the approach you've been using for creating web pages where the style (CSS) is separated from the content (HTML).

Unlike most word processors, LaTex is \textbf{not} a WYSIWYG (what you see is what you get) system. The document you edit (a \texttt{*.tex} file) is not your final output (its usually a \texttt{*.pdf} file).
...
\hypertarget{ex1}{%
\section{Exercise one: document}\label{ex1}}
...
and when you compile you need to run \texttt{pdflatex} before and after running \texttt{bibtex} like this:
...
LaTeX provides powerful tools for typesetting mathematics and this chapter looks at some of them. If you can't see the equations and matrix below in your web browser, you'll need to use the pdf version of this document at \href{https://latex4year1.netlify.app/latex4year1.pdf}{latex4year1.pdf}. Otherwise, if you can see the equation below, it is safe to read on\ldots{}
...
\hypertarget{ex3}{%
\section{Exercise three: maths}\label{ex3}}
...
Compared to LaTeX, overleaf is relatively new (founded in 2013) and has several features which you might find useful:
...
\item
  If you want to take it further see how to create tables in the \emph{creating Tables} tutorial\footnote{\url{https://www.overleaf.com/learn/latex/Learn_LaTeX_in_30_minutes\#Creating_tables}}
\end{enumerate}

\hypertarget{overleafconc}{%
\section{Summary}\label{overleafconc}}

Overleaf provides a modern and convenient cloud based interface to tried and tested LaTeX tools, which have been around for over thirty years. \citep{knuth} It also allows you to share the source of your documents while providing some handy templates for common document types. Which toolset is ``best'' for you will largely depend on what kind of documents you are working on. In the next chapter we will create a curriculum vitae using CV templates provided by overleaf.
