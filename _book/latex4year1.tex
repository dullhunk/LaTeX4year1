...
Overleaf is a handy tool for creating LaTeX documents. While LaTeX is a mature and established typesetting system that has been around since 1980's, \citep{knuth} overleaf brings it up to date with a convenient cloud based interface. In the next chapter we will create a curriculum vitae using CV templates provided by overleaf.
